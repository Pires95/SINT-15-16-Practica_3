...
Consulta 2, Año-><%=(String)session.getAttribute("anho")%>
<form method="POST" action="?fase3">
    <input type="hidden" name="fase" value="211">
    ...
    <input type="radio" name="album" value="todos" checked>Todos<br>
    <input type="submit" value="Enviar">
    <input type='submit' value='Inicio' onclick='form.fase.value=0'>
    <input type='submit' value='Atras' onclick='form.fase.value=1'><br>
</form>
